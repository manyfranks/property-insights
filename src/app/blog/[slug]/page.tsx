...
const FAQ_MAP: Record<string, { question: string; answer: string }[]> = {
  ...
  "property-assessment-vs-market-value-canada": [
    { question: "What is the difference between assessed value and market value in Canada?", answer: "Assessed value is a government estimate set on a fixed valuation date, used mainly to calculate property tax. Market value is what a buyer would actually pay for the property today. They diverge because assessments update on a fixed cycle using mass-appraisal models, while market value moves in real time with comparable sales, condition, and buyer competition." },
    { question: "How often are property assessments updated in Canada?", answer: "It varies by province. BC Assessment and Alberta's municipal assessors (Calgary and Edmonton) update annually, each reflecting a July 1 valuation date from the prior year. Ontario is the exception: MPAC has not conducted a province-wide reassessment since a January 1, 2016 valuation date, and that update has been postponed repeatedly, with no new date confirmed as of the 2026 tax year." },
    { question: "Can you look up a property's assessed value for free?", answer: "Yes, in all three provinces. BC Assessment values are searchable at bcassessment.ca. Calgary and Edmonton publish theirs through free, no-login open-data (SODA) APIs. Ontario homeowners can view their own property through MPAC's AboutMyProperty portal, though broader public look-ups of other addresses are more limited." },
    { question: "Does a big assessment gap mean I should offer less?", answer: "Not automatically. A large gap between assessed value and asking price is useful context — it tells you the asking price hasn't been validated by an independent source — but it should be weighed alongside comparable sales, days on market, and the property's condition, not treated as an automatic discount." },
  ],
  ...
  "how-much-below-asking-price-to-offer-canada": [
    { question: "How much below asking price should I offer on a house in Canada?", answer: "There is no fixed number that applies to every property. Build a range from the assessed value, closed comparable sales, days on market, and the property's condition, and name your assumptions as you go. In a buyer's market, 5% to 15% below asking is common for listings with clear motivation signals; in a seller's market, the realistic range is often narrower." },
    { question: "Is it rude to offer well below asking price?", answer: "No. The asking price is a negotiation starting point, not a final number, and sellers expect offers below it. An offer backed by assessment data, comparable sales, and market timing is informed, not disrespectful. The seller can counter or decline — that is the normal process, not a breach of etiquette." },
    { question: "Does days on market change how much I should offer?", answer: "Yes. Days on market is one of the stronger signals of seller flexibility. A listing at 30 days hasn't been tested long enough to reveal motivation. One at 90+ days has been seen and passed on by the active buyer pool at the current price, which often means more room to negotiate — though condition and location can also explain a long DOM count." },
    { question: "Should my offer be based on the assessed value alone?", answer: "No. The assessed value is one input, not the whole answer — it lags the market by months in BC and Alberta and by close to a decade in Ontario. Use it alongside comparable sales, days on market, and condition rather than as a stand-alone target price." },
    { question: "When should I involve a lawyer, inspector, or appraiser?", answer: "Bring in a home inspector before waiving an inspection condition or finalizing your price on any property with visible deferred maintenance. Bring in an appraiser's perspective if your offer sits above recent comparables. A real estate lawyer is required in most Canadian provinces to close the transaction and should review your offer before you sign anything you don't fully understand." },
  ],
