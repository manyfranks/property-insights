        ...
        <table className="w-full text-sm min-w-[760px]">
          <thead>
            <tr className="border-b border-border bg-background/60">
              ...
              <th scope="col" className="sticky top-0 z-10 bg-background px-4 py-3 text-xs uppercase tracking-widest text-muted font-medium border-b border-border text-center">
                1% Rule
              </th>
            </tr>
          </thead>
