...
export const alt = "Property Assessment Appeal Checker — Property Insights";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", fontSize: "22px", color: "#6b7280", lineHeight: 1.5 }}>
          <span>Free appeal checker — see if a property tax appeal</span>
          <span>is worth it, and how much it could save you.</span>
        </div>

        {/* URL */}
        <div style={{ fontSize: "18px", color: "#9ca3af", position: "absolute", bottom: "40px", left: "80px" }}>
          propertyinsights.xyz/tools/appeal-checker
        </div>
      </div>
    ),
    { ...size }
