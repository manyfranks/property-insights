 ...
 *
 * The "availability varies / licensed insurance partner only" compliance disclaimer,
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-8 py-4">
      <p className="text-xs leading-relaxed text-center text-muted">
        Availability varies by region. You&apos;ll only ever continue to a licensed insurance partner — Property Insights
