...
|---|---|---|---|---|
| **P0 — Safety baseline** | `[x] Complete; quota-copy regression hardened 2026-08-12` | Prevent address-only residential overclaims; lock vocabulary and fixtures | None | 16/16 P0 fixtures; 16/16 guard; 20/20 integration |
...
- Fixture report: `13A-P0-BASELINE-AND-VOCABULARY.md`; 16/16 offline fixtures
- Quota/address regression: `20-SEATTLE-QUOTA-REGRESSION.md`; provider-not-called, provider-error, and clean-miss states are visibly distinct
...
|---|---:|---:|---:|---|
| Baseline fixtures passing | 16/16 | 16/16 | 100% | 2026-08-12 |
